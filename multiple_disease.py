...
if (selected == 'Home'):
    ...
    if st.session_state.is_logged_in:
        ...
        if (selected == 'Diabetes Prediction'):
            ...
            with col2:
                Glucose = st.number_input('Glucose Level(70-125)',value=None,  placeholder="number only", min_value=0, step=1, format='%d')
                


            with col3:
                BloodPressure = st.number_input('Blood Pressure value(Diastollic)',value=None,  placeholder="number only", min_value=0, step=1, format='%d')
            
            with col1:
                SkinThickness = st.number_input('Skin Thickness value(1.08-4.36mm)',value=None,  placeholder="number only", min_value=0, step=1, format='%d')
            
            with col2:
                Insulin = st.number_input('Insulin Level(16-170)',value=None,  placeholder="number only", min_value=0, step=1, format='%d')
            
            with col3:
                BMI = st.number_input('BMI value(18.5-24.9)',value=None,  placeholder="number only", min_value=0.0, step=0.1)
            
            with col1:
                DiabetesPedigreeFunction = st.number_input('Diabetes Pedigree Function value(0-3)',value=None,  placeholder="number only", min_value=0.0, step=0.1)
        ...
        if (selected == 'Heart Disease Prediction'):
            ...
            with col1:
                trestbps = st.number_input('Resting Blood Pressure(Systolic)',value=None,  placeholder="number only", min_value=0, step=1, format='%d')
                
                
            with col2:
                chol = st.number_input('Serum Cholestoral in mg/dl(200)',value=None,  placeholder="number only", min_value=0, step=1, format='%d')
            ...
            with col2:
                thalach = st.number_input('Maximum Heart Rate achieved(220-age)',value=None,  placeholder="number only", min_value=0, step=1, format='%d')
        ...
        if (selected == "Parkinsons Prediction"):
            ...
            with col1:
                fo = st.number_input('MDVP:Fo(150)',value=None,  placeholder="number only", min_value=0.0, step=0.0001,format='%0.4f')
                
                

            with col2:
                fhi = st.number_input('MDVP:Fhi(300)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col3:
                flo = st.number_input('MDVP:Flo(100)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col4:
                Jitter_percent = st.number_input('MDVP:Jitter(0.005)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col5:
                Jitter_Abs = st.number_input('MDVP:Jitter(Abs(0.0004))',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col1:
                RAP = st.number_input('MDVP:RAP(0.003)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col2:
                PPQ = st.number_input('MDVP:PPQ(0.003)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col3:
                DDP = st.number_input('Jitter:DDP(0.004)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col4:
                Shimmer = st.number_input('MDVP:Shimmer(0.02)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col5:
                Shimmer_dB = st.number_input('MDVP:Shimmer(0.1dB)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col1:
                APQ3 = st.number_input('Shimmer:APQ3(0.01)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col2:
                APQ5 = st.number_input('Shimmer:APQ5(0.01)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col3:
                APQ = st.number_input('MDVP:APQ(0.01)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col4:
                DDA = st.number_input('Shimmer:DDA(0.03)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col5:
                NHR = st.number_input('NHR(0.01)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col1:
                HNR = st.number_input('HNR(0.01)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col2:
                RPDE = st.number_input('RPDE(20)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col3:
                DFA = st.number_input('DFA(0.5)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col4:
                spread1 = st.number_input('spread1(0.6)',value=None,  placeholder="number only", min_value=-1000.0, step=0.1,format='%0.4f')
                
            with col5:
                spread2 = st.number_input('spread2(-4)',value=None,  placeholder="number only", min_value=-1000.0, step=0.1,format='%0.4f')
                
            with col1:
                D2 = st.number_input('D2(0.1)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
                
            with col2:
                PPE = st.number_input('PPE(2)',value=None,  placeholder="number only", min_value=0.0, step=0.1,format='%0.4f')
